...
import { ConsoleReporter, MarkdownReporter, JsonReporter } from '../../src/reporters/index.js';
...
function createMockReport(overrides: Partial<LoadTestReport> = {}): LoadTestReport {
  return {
    ...
    toolLatencies: [
      {
        toolName: 'search',
        latency: { p50: 45, p90: 120, p95: 200, p99: 340, min: 10, max: 500, mean: 80, samples: 4521 },
      },
      {
        toolName: 'process',
        latency: { p50: 89, p90: 230, p95: 350, p99: 520, min: 20, max: 800, mean: 150, samples: 3214 },
      },
    ],
    errorSummary: {
      totalErrors: 12,
