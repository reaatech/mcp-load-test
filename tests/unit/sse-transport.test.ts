...
import { SSETransport } from '../../src/mcp-client/transports/sse.js';
...
vi.mock('eventsource', () => {
  class MockEventSource {
    ...
    emit(event: string, data: unknown) {
      ...
      const msgEvent = { data: typeof data === 'string' ? data : JSON.stringify(data) } as MessageEvent;
...
describe('SSETransport', () => {
  ...
  it('should send request after endpoint is established', async () => {
    ...
    // Need to access the private eventSource to emit endpoint
