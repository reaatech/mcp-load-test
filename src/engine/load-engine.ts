...
import { BreakingPointDetector } from '../breaking-point/index.js';
import { Grader } from '../grading/index.js';
...
export class LoadEngine {
  ...
  async run(): Promise<LoadTestReport> {
    ...
    report.grade = this.grader.grade(report, { maxObservedConcurrency: this.maxObservedConcurrency });
